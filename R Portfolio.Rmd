...
lwrb <- fit_gamma$estimate['shape'] - z_score * sqrt(shape_var)
uprb <- fit_gamma$estimate['shape'] + z_score * sqrt(shape_var)
...
lwrb2 <- fit_gamma$estimate['rate'] - z_score * sqrt(rate_var)
uprb2 <- fit_gamma$estimate['rate'] + z_score * sqrt(rate_var)
